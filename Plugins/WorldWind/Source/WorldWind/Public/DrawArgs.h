...
public:	
	...
	UDrawArgs(const FObjectInitializer& ObjectInitializer);*/
	
public:
	/*public Device device;
	public System.Windows.Forms.Control parentControl;
	public static System.Windows.Forms.Control ParentControl = null;*/
	int32 numBoundaryPointsTotal;
	int32 numBoundaryPointsRendered;
	int32 numBoundariesDrawn;
	...
	FIntPoint MouseDownStartPosition;
	int32 numberTilesDrawn;
	FIntPoint CurrentMousePosition;
	bool isMouseDragging;
	FString UpperLeftCornerText = FString(TEXT(""));
	// 这里不是指针
	//CameraBase WorldCamera;
